...
import { EmptyChartState } from "@/components/charts";
...
export async function TemposRespostaContent({
  ...
  try {
          ...
          <>
            ...
            <div className="rounded-2xl border border-border bg-muted/30 p-5">
              ...
              {compareData.every(
                ...
                <TemposRespostaBar data={compareData} />
              )}
            </div>
          </>
        )}
    ...
    console.error("[TemposRespostaContent] erro:", err);
    return (
      <ErrorState
        title="Não foi possível carregar Tempos de resposta"
