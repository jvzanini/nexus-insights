...
export async function CsatContent({ accountId }: DashboardContentProps) {
  try {
        ...
        <div className="space-y-6">
          ...
          <div className="mx-auto flex max-w-2xl flex-col items-center rounded-2xl border border-border bg-muted/20 p-12 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Habilite o CSAT (Customer Satisfaction Survey) no Chatwoot para
              que as respostas comecem a aparecer aqui automaticamente.
            </p>
            <a
              href={CSAT_DOCS_URL}
              target="_blank"
    ...
    console.error("[CsatContent] erro:", err);
    return (
      <ErrorState
        title="Não foi possível carregar CSAT"
