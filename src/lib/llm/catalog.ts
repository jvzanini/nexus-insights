...
export const PROVIDER_CATALOG: Record<LlmProvider, ProviderCatalog> = {
  openai: {
    ...
    models: [
      ...
      { id: "gpt-5.5-pro", label: "GPT-5.5 Pro", tier: "high", released: "2026-04" },
      { id: "gpt-5.4", label: "GPT-5.4", tier: "high", released: "2026-04" },
      { id: "gpt-5.4-pro", label: "GPT-5.4 Pro", tier: "high", released: "2026-04" },
      ...
      { id: "o3-pro", label: "o3-pro", tier: "high", notes: "raciocínio", released: "2025-04" },
